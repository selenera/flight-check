...
export async function GET(request: NextRequest) {
  try {
    ...
    // Fetch return prices: origin → destination
    // Note: Frontend already reverses the route (passes destination as origin and origin as destination)
    ...
    console.error('Error fetching Amadeus return prices:', error);
    return NextResponse.json(
      {
        success: false,
